...
bot = telebot.TeleBot('7191815416:AAHNrsw5rX3FbyaVcVbom5QLmurPdEU7cNs')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @LEGEND_ADMIN123"
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @LEGEND_ADMIN123 ."
        ...
        if len(command) == 4:  # Updated to accept target, port, and time
            ...
            if time > 150:
                ...
                try:
                    ...
                    full_command = f"./FLASHxBGMI {target} {port} {time} 1050"
...
3. MAKE SURE YOU JOINED https://t.me/+2h6IjvBZXRg0YmI1 OTHERWISE NOT WORK
